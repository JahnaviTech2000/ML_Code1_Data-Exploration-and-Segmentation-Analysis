...
# Create a table of cluster assignments vs. 'Gender' variable
cluster_gender_table = pd.crosstab(mcdonalds['Cluster'], mcdonalds['Gender'])
...
fig, _ = mosaic(cluster_gender_table.stack(), gap=0.02, labelizer=labelizer, title='', axes_label=False)
